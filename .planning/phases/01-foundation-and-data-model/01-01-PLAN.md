...
- Environment: POSTGRES_DB=bulgarian_vocab, POSTGRES_USER=vocab_user, POSTGRES_PASSWORD=set via .env
- Port: 5432:5432
...
- spring.datasource: PostgreSQL connection (localhost:5432/bulgarian_vocab, vocab_user/password from .env)
